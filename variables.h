...
#define DEFAULT_DEVICE_ON_TIME_EXTENDED_MS 999000
#define DEFAULT_DEVICE_SLEEP_TIME_MS       (00000 + 5000)

#define MAC_FILE_ID                        0x0001 /** STORAGE	 */
#define MAC_RECORD_KEY                     0x0002
#define MAC_REPEATER_RECORD_KEY            0x0003

#define TIME_FILE_ID                       0x0004
#define TIME_ON_RECORD_KEY                 0x0005
#define TIME_SLEEP_RECORD_KEY              0x0006
#define TIME_ON_EXTENDED_RECORD_KEY        0x0007
#define DATE_AND_TIME_FILE_ID              0x0008
#define DATE_AND_TIME_RECORD_KEY           0x0009
#define HISTORY_FILE_ID                    0x000a
#define HISTORY_COUNTER_RECORD_KEY         0x000b
