...
#define RTC_INSTANCE  NRFX_RTC_INSTANCE(2)
#define RTC_ON_TICKS (12 * 8) // 120 ticks
#define RTC_SLEEP_TICKS (25 * 8) // 160 ticks
...
static nrfx_rtc_t m_rtc = RTC_INSTANCE;
...
void bsp_event_handler(bsp_event_t event)
{
    ...
    switch (event) {
        case BSP_EVENT_SLEEP: nrf_pwr_mgmt_shutdown(NRF_PWR_MGMT_SHUTDOWN_GOTO_SYSOFF); break;

        case BSP_EVENT_DISCONNECT: break;
