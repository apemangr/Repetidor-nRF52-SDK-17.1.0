 ...
 * product. You need to analyze how your product is supposed to react in case of
 * assert.
...
void uart_event_handle(app_uart_evt_t *p_event)
{
	...
	switch (p_event->evt_type)
	{
		...
		case APP_UART_DATA_READY:
			...
			{
				NRF_LOG_DEBUG(
				    "Ready to send data over BLE NUS client and server");
 ...
 *
 * @details Handles any pending log operations, then sleeps until the next event
 * occurs.
 */
